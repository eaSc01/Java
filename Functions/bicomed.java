...
public class bicomed {
    ...
    public static double bi_coefficent(int n, int r) {
        ...
        */
        ...
        double bi_coefficent =  (fact(n)/(fact(r) * fact(n-r)));
        return bi_coefficent;
    }
    ...
    public static void main(String args[]) {
        ...
        int r = scan.nextInt();
        double binomialcoefficent = bi_coefficent(n, r);
